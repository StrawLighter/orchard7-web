...
const HOTSPOTS = [
  { id: "bank", label: "Village Bank", sub: "Emergency Exit", x: 25.9, y: 45.3, w: 6.8, h: 4.2, glowColor: "rgba(181,133,27,0.4)" },
  { id: "harvest", label: "Harvest Tree", sub: "Claim Rewards", x: 53.9, y: 31.1, w: 6.8, h: 4.2, glowColor: "rgba(181,133,27,0.5)" },
  { id: "groves", label: "Apple Orchard", sub: "Stake SOL", x: 83.0, y: 45.4, w: 6.8, h: 4.2, glowColor: "rgba(45,106,79,0.5)" },
  { id: "cellar", label: "Ancient Cellar", sub: "BluApple Vault", x: 28.7, y: 81.5, w: 6.8, h: 4.2, glowColor: "rgba(100,149,237,0.4)" },
